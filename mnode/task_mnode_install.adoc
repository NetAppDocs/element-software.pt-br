...
. Transfira a OVA ou ISO para a sua instalação a partir da link:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Software Element"^]página no site de suporte da NetApp. O novo OVA contém um certificado SSL atualizado.
+
