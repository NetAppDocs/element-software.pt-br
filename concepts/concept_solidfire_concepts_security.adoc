...
Para configurar a MFA, consulte link:../storage/task_system_manage_mfa_set_up_multi_factor_authentication.html["ativar autenticação multifator"] documentação.
