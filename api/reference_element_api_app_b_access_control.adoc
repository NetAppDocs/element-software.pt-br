...
NOTE: Existem tipos de acesso disponíveis através da API que não estão disponíveis na IU do Element.
...
link:../storage/concept_system_manage_manage_cluster_administrator_users.html#view-cluster-admin-details["Saiba mais sobre os tipos de acesso disponíveis na IU do Element"]
