...
IosInProgress
 a| 
O número de I/os para esta unidade que estão em andamento.
 a| 
número inteiro
...
lê
 a| 
O número de chamadas read() por segundo para esta unidade.
 a| 
número inteiro
...
ReadsCombined
 a| 
O número de chamadas read() para setores adjacentes que podem ser combinados em uma leitura maior.
 a| 
número inteiro
...
ReadMseg
 a| 
O número de milissegundos gastos com leitura.
 a| 
número inteiro
...
WritesCombined
 a| 
O número de chamadas write() para setores adjacentes que podem ser combinados em uma gravação maior.
 a| 
número inteiro
...
Escreva o seu comentário
 a| 
O número de milissegundos gasto escrevendo.
 a| 
número inteiro
