...
summary: Você pode usar o método GetNodeSSLCertificate para recuperar o certificado SSL atualmente ativo no nó de gerenciamento. 
---
...
certificado
 a| 
O texto completo codificado em PEM do certificado.
 a| 
cadeia de carateres
