...
[NOTE]
====
* Este método não ativa a encriptação de software em repouso. Isso só pode ser feito usando o link:../api/reference_element_api_createcluster.html["criar método de cluster"^] com `enableSoftwareEncryptionAtRest` definido como `true`.
