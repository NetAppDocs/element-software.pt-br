...
summary: O método GetConfig retorna uma resposta semelhante ao exemplo a seguir. Devido ao tamanho, a resposta contém informações apenas para um nó do cluster. 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
O `GetConfig` método retorna uma resposta semelhante ao exemplo a seguir. Devido ao tamanho, a resposta contém informações apenas para um nó do cluster.
