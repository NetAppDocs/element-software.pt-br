...
* link:task_data_protection_back_up_a_volume_snapshot_to_an_amazon_s3_object_store.html["Faça backup de um snapshot de volume em um armazenamento de objetos do Amazon S3"]
* link:task_data_protection_back_up_a_volume_snapshot_to_openstack_swift.html["Fazer backup de um snapshot de volume para um armazenamento de objetos OpenStack Swift"]
* link:task_data_protection_back_up_volume_to_solidfire.html["Fazer backup de um snapshot de volume em um cluster SolidFire"]
