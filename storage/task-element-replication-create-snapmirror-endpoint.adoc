...
[role="lead"]
Você precisa criar um endpoint SnapMirror antes de poder criar uma relação de replicação. Você só pode realizar essa tarefa na interface web do software Element ou usando o link:../api/reference_element_api_abortsnapmirrorrelationship.html["Métodos de API do SnapMirror"].
