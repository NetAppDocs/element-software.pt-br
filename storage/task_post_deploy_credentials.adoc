...
Interações do componente NetApp SolidFire: image:../media/diagram_credentials_solidfire.png["Componentes do NetApp SolidFire"]
...
* Atualize as credenciais de administrador do cluster de armazenamento no mnode usando o link:../api/reference_element_api_modifyclusteradmin.html["API de modificação exclusiva"].
...
* Para nós de H410C, H610C e H615C, link:https://docs.netapp.com/us-en/hci/docs/hci_prereqs_final_prep.html["Altere a senha padrão do IPMI"^].
* Para nós de H410S e H610S, link:task_post_deploy_credential_change_ipmi_password.html["Altere a senha padrão do IPM"].
* link:https://docs.netapp.com/us-en/hci/docs/task_hcc_edit_bmc_info.html["Altere as credenciais do BMC no nó de gerenciamento"^].
...
Quando as credenciais raiz ESXi são alteradas por um administrador da VMware, as credenciais dos respetivos nós de computação devem ser atualizadas no nó mnode para manter a funcionalidade de Controle de nuvem híbrida.
 a| 
link:https://docs.netapp.com/us-en/hci/docs/task_hci_credentials_vcenter_esxi.html["Atualizar credenciais para hosts do vCenter e do ESXi"^].
...
* link:task_system_manage_mfa_set_up_multi_factor_authentication.html["Ativar a autenticação multifator"]
