...
* * Controlador de gerenciamento de placa base (BMC) atualizado para H610S nós*: Você atualizou a versão do BMC para seus H610S nós. link:https://docs.netapp.com/us-en/hci/docs/rn_H610S_BMC_3.84.07.html["notas de versão e instruções de atualização"^]Consulte .



NOTE: Para obter uma matriz completa de firmware e firmware de driver para seu hardware, link:../hardware/fw_storage_nodes.html["Versões de firmware de storage compatíveis para nós de storage do SolidFire"]consulte .
