...
* <<Configurar um nó de storage usando a IU por nó,IU por nó>>Utilize a interface de usuário por nó. (`https://<node_management_IP>:442`) para configurar as definições de rede do nó.
